      ...
      <nav className="inline-flex justify-center w-max min-w-[85%] md:min-w-[500px] glass-nav rounded-full px-8 md:px-12 py-3 md:py-4 shadow-lg">
        <div className="flex justify-between items-center w-full max-w-[600px] flex-nowrap">
          ...
          <div className="flex gap-6 md:gap-12 items-center flex-nowrap whitespace-nowrap">
            <Link href="#works" className="nav-link text-white font-bold text-[1rem] md:text-[1.2rem] hover:text-[#f7cdb5]">WORKS</Link>
            <Link href="#about" className="nav-link text-white font-bold text-[1rem] md:text-[1.2rem] hover:text-[#f7cdb5]">ABOUT</Link>
            <Link href="#contact" className="nav-link text-white font-bold text-[1rem] md:text-[1.2rem] hover:text-[#f7cdb5]">CONTACT</Link>
          </div>
        </div>
      </nav>
    </center>
