  ...
  return (
    <section className="showreel-section py-24 md:py-32" id="works">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        <div className="flex justify-center items-center mb-24 md:mb-32">
        ...
        <div className="flex flex-col gap-32 md:gap-48">
          ...
          <div className="design-item flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0">
            <div className="design-image w-full md:w-[55%] lg:w-[55%] order-1 rounded-lg overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.15)] group z-0 film-border-frame p-3 md:p-5 bg-[#111] transform -rotate-2 hover:rotate-0 transition-all duration-500 ease-out cursor-pointer hover:scale-105 shrink-0">
            ...
            <div className="design-text w-full md:w-[40%] lg:w-[38%] order-2 bg-white/80 backdrop-blur-md p-8 md:p-12 rounded-[2rem] shadow-xl border border-white/40 z-10 transition-transform duration-500 hover:-translate-y-2 shrink-0">
          ...
          <div className="design-item flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0 mt-24 md:mt-0">
            <div className="design-text w-full md:w-[40%] lg:w-[38%] order-2 md:order-1 bg-white/80 backdrop-blur-md p-8 md:p-12 rounded-[2rem] shadow-xl border border-white/40 z-10 transition-transform duration-500 hover:-translate-y-2 shrink-0">
            ...
            <div className="design-image w-full md:w-[55%] lg:w-[55%] order-1 md:order-2 rounded-lg overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.15)] group z-0 film-border-frame p-3 md:p-5 bg-[#111] transform rotate-3 hover:rotate-0 transition-all duration-500 ease-out cursor-pointer hover:scale-105 shrink-0">
              <div className="relative w-full overflow-hidden">
                <video autoPlay loop muted playsInline className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700 ease-out rounded-sm">
          ...
          {/* ITEM 3 */}
          <div className="design-item flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0 mt-24 md:mt-0">
            <div className="design-image w-full md:w-[55%] lg:w-[55%] order-1 rounded-lg overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.15)] group z-0 film-border-frame p-3 md:p-5 bg-[#111] transform -rotate-3 hover:rotate-0 transition-all duration-500 ease-out cursor-pointer hover:scale-105 shrink-0">
              <div className="relative w-full overflow-hidden">
                <video autoPlay loop muted playsInline className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700 ease-out rounded-sm">
